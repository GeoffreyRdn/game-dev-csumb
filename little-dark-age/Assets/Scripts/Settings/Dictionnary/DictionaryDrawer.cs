...
namespace Settings
{
    public abstract class DictionaryDrawer<TK, TV> : PropertyDrawer
    {
        ...
        private void AddNewItem()
        {
            ...
            if (typeof(TK) == typeof(string))
                key = (TK)(object)"";
            else if (typeof(TK) == typeof(GameObject))
                key = (TK) (object) Camera.main.gameObject;
            else key = default(TK);
    ...
    // TODO
    // ADD ALL CUSTOMS DICTIONARY HERE
    
    [CustomPropertyDrawer(typeof(StringFloatDictionary))]
    public class StringFloatDictionaryDrawer : DictionaryDrawer<string, float> { }
}
